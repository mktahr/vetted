...
const { data: exps, error: expErr } = await supabase
  ...
  .select('person_experience_id, person_id, title_raw, description_raw, specialty_normalized, function_normalized, employment_type_normalized, start_date, is_current')
  .order('person_id')
