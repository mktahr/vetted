...
2. **Four-axis candidate taxonomy rebuild**
...
3. **AI chat search + auto-tagging** — THE wedge feature. Must ship pre-launch. Natural-language search over candidates + companies; auto-tagging of new candidates as they're ingested. Three-layer matching (specific title + normalized role + domain inference) depends on the four-axis taxonomy from item 2.
