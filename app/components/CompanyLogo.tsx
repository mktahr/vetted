...
export function guessSchoolDomain(schoolName: string | null | undefined): string | null {
  ...
  const OVERRIDES: Record<string, string> = {
    ...
    'indian institute of technology (iit)': 'iitb.ac.in',
    ...
    'oxford': 'ox.ac.uk',
    'polytechnic institute of paris (ecole)': 'ip-paris.fr',
    'psl (paris)': 'psl.eu',
    'purdue': 'purdue.edu',
